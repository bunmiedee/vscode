...
export enum ChatConfiguration {
	...
	TitleBarAgentGridModeEnabled = 'chat.titleBar.agentGridMode.enabled',
...
export const TOGGLE_AGENT_GRID_MODE_COMMAND_ID = 'workbench.action.chat.toggleAgentGridMode';
